...
1. Once you run `npm start`, a new tab opens up in your browser. This is where you can view, test, and debug the mobile app. To see the app, make sure that you have "Expo Go" installed on your phone.
2. On the left panel, change the connection from "LAN" to “Tunnel”.
