...
const JayShopHours = () => {
    ...
    const { "open hours": openHours } = jayShop;
                        ...
                        <View style={styles.alignSideBySide}>
                            ...
                            <FlatList
                                ...
                                renderItem={({ item: hours }) => (
                                    <Subheading styles={styles.hours}>
                                        {hours}
                                    </Subheading>
                                )}
                            />
...
const styles = StyleSheet.create({
    ...
    alignSideBySide: {
        // this align the Days and Hours next to each other but space-between
        flexDirection: "row",
